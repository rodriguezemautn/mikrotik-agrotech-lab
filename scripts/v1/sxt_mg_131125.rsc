# nov/13/2025 18:14:00 - Rev. 2 - Archivo SXT-MG
# ========================================
...
/interface wireless
set wlan1 disabled=no mode=ap-bridge ssid="AGROTECH-PTP-8KM" band=2ghz-b/g/n frequency=2437 \
    channel-width=20mhz wireless-protocol=nv2 nv2-qos=frame-priority security-profile=PtP-Secure \
    wds-mode=dynamic wds-default-bridge=BR-PTP tx-power=27 country=argentina installation=outdoor

/interface bridge port
add bridge=BR-PTP interface=wlan1
add bridge=BR-PTP interface=ether1 comment="To MK02"
...
# El cliente SMTP no se configura aquí, ya que el SXT-MG actúa como L2 de tránsito.
