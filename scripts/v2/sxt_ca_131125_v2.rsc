...
# Cambios Rev.3: mode=station-bridge, frequency fixed, MTU=1590, WPA3
# ========================================
...
/interface wireless
set wlan1 disabled=no mode=station-bridge ssid="AGROTECH-PTP-8KM" band=2ghz-b/g/n frequency=2437 channel-width=20mhz wireless-protocol=nv2 nv2-qos=frame-priority security-profile=PtP-Secure tx-power=27 country=argentina installation=outdoor mtu=1590

/interface bridge port
add bridge=BR-PTP interface=wlan1 ingress-filtering=yes frame-types=admit-only-vlan-tagged
add bridge=BR-PTP interface=ether1 comment="To MK03" ingress-filtering=yes frame-types=admit-only-vlan-tagged
