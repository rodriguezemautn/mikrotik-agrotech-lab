...
- **Procesador:** AR9344 600MHz MIPSBE, 1 core
- **Memoria:** 128MB RAM / 128MB NAND Storage
- **Wireless:** 2.4GHz 802.11b/g/n, hasta 300Mbps, 2 cadenas
- **Puertos:** 5x Ethernet 10/100Mbps
- **PoE:** Entrada (8-30V) y salida pasiva (500mA en ether5)
- **Antena:** Integrada 2.5dBi para 2.4GHz
- **Rango operativo:** -20°C a +60°C

**Ventajas para Radioenlaces:**
- Soporte WDS nativo para transporte VLAN transparente
- Bajo consumo energético (7W sin accesorios)
- Resistencia ambiental adecuada para instalaciones rurales
- Costo-efectivo para implementaciones distribuidas
